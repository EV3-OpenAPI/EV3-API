...
request_path_port = api_client.PathParameter(
    name="port",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PortSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = TachoMotor
...
class BaseApi(api_client.Api):
    @typing.overload
    def _motor_tacho_type_port_get_oapg(
        self,
...
class MotorTachoTypePortGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def motor_tacho_type_port_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def motor_tacho_type_port_get(
        ...
        return self._motor_tacho_type_port_get_oapg(
