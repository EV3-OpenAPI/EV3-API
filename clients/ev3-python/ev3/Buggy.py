...
from ev3api.models.motor_steer_counts_post_request import MotorSteerCountsPostRequest
from ev3api.models.motor_steer_duration_post_request import MotorSteerDurationPostRequest
from ev3api.models.steering_unit import SteeringUnit
from ev3api.models.tacho_motor import TachoMotor
...
class Buggy(EV3):
    ...
    def on_for_seconds(self, speed_percent: int, seconds: float) -> None:
        ...
        self.left.time_setpoint = int(seconds * 1000)
        self.right.time_setpoint = int(seconds * 1000)
